...
CREATE TYPE "public"."workspace_role" AS ENUM('owner', 'admin', 'user', 'guest');--> statement-breakpoint
CREATE TYPE "public"."workspace_tier" AS ENUM('free', 'starter', 'pro', 'enterprise');--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "individuals" ADD CONSTRAINT "individuals_contact_id_contacts_id_fk" FOREIGN KEY ("contact_id") REFERENCES "public"."contacts"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "companies" ADD CONSTRAINT "companies_contact_id_contacts_id_fk" FOREIGN KEY ("contact_id") REFERENCES "public"."contacts"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
