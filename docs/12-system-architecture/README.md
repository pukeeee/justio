...
### 12.1.1. Вхідна точка: Edge Proxy (`src/proxy.ts`)
...
#### 12.2.3. Серверні дії (Server Actions)
...
## 12.3. Архітектура Офлайн-роботи (Offline-First)
...
## 12.4. Архітектура Коду: Feature-Sliced Design та Сервісний Шар
...
### 12.4.1. Feature-Sliced Design (FSD)
...
### 12.4.2. Доповнення FSD: Сервісний Шар та Репозиторії
...
## 12.5. Обмеження безкоштовних тарифів та їх обхід (MVP)
...
## 12.6. Цільова Архітектура (масштабування на VPS)
