...
Монетизація продукту базується на моделі щомісячної або щорічної підписки (SaaS) з різними тарифними планами, а також на можливості докуповувати окремі модулі.

## 8.1. Тарифні Плани

Тарифні плани розроблені для задоволення потреб бізнесу на різних етапах його розвитку.

| План | Орієнтовна ціна (UAH/міс) | Користувачі | Контакти | Сховище | Ключові особливості |
|---|---|---|---|---|---|
| **Free** | 0 | 2 | 100 | 500 MB | Базовий функціонал CRM (контакти, угоди), обмежена інтеграція з «Нова Пошта». |
| **Starter** | 299 | 5 | 5,000 | 5 GB | Повний базовий функціонал, пріоритетна підтримка, можливість докуповувати модулі. |
| **Pro** | 799 | 20 | 50,000 | 50 GB | Все з тарифу "Starter", плюс розширена аналітика, автоматизація та доступ до API. |
| **Enterprise** | Індивідуально | Необмежено | Необмежено | Необмежено | Все з "Pro", плюс White-label, персональний менеджер, можливість кастомних доопрацювань. |
