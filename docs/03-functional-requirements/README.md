...
*   **Запрошення користувачів:** Власник або Адміністратор може запрошувати нових членів команди в організацію по email. Запрошений користувач переходить за посиланням та створює свій обліковий запис.
